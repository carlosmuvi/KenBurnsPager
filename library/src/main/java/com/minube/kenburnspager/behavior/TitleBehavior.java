package com.minube.kenburnspager.behavior;
...
import com.minube.kenburnspager.R;
...
public class TitleBehavior extends CoordinatorLayout.Behavior<TextView> {
    ...
    public TitleBehavior(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mCustomFinalYPosition = a.getDimension(R.styleable.TitleBehavior_finalYPosition, 0);
            mCustomStartXPosition = a.getDimension(R.styleable.TitleBehavior_startXPosition, 0);
            mCustomStartToolbarPosition = a.getDimension(R.styleable.TitleBehavior_startToolbarPosition, 0);
            mCustomStartHeight = a.getDimension(R.styleable.TitleBehavior_startHeight, 0);
            mCustomFinalHeight = a.getDimension(R.styleable.TitleBehavior_finalHeight, 0);
        ...
        mFinalLeftAvatarPadding = context.getResources().getDimension(R.dimen.left_text_padding);
    }
    ...
    @Override public boolean onDependentViewChanged(CoordinatorLayout parent, TextView child, View dependency) {
        ...
        if (expandedPercentageFactor < mChangeBehaviorPoint) {
            ...
            float distanceYToSubtract =
                ((mStartYPosition - mFinalYPosition) * (1f - expandedPercentageFactor)) + (child.getHeight() / 2);
    ...
    private void maybeInitProperties(TextView child, View dependency) {
        ...
        if (mFinalXPosition == 0) {
            mFinalXPosition =
                mContext.getResources().getDimensionPixelOffset(R.dimen.abc_action_bar_content_inset_material)
